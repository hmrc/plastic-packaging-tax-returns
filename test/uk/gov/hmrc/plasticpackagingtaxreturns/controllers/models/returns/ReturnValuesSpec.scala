...
class ReturnValuesSpec extends PlaySpec {
  ...
  "NewReturnValues" should {
    "extract value from userAnswer" in {
      ...
      val result = NewReturnValues.apply(CreditClaimed(10L, 5), 10)(UserAnswers("123", ReturnTestHelper.returnWithCreditsDataJson))
    ...
    "Return None if cannot get value from useAnswer" in {
      val result = NewReturnValues.apply(CreditClaimed(10L, 5), 10)(UserAnswers("123", ReturnTestHelper.invalidReturnsDataJson))
    ...
    "return exportedByAnotherBusiness value of zero if missing" in {
      ...
      val result = NewReturnValues.apply(CreditClaimed(10L, 5), 10)(ans)
